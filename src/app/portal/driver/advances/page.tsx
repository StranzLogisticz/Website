    ...
    <div className="min-h-screen bg-muted/20 pb-8">
      <header className="sticky top-0 z-10 border-b bg-background/95 backdrop-blur">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-2"><Button asChild size="icon" variant="ghost"><Link href="/portal/driver"><ArrowLeft className="h-5 w-5" /></Link></Button><h1 className="text-base font-bold">{t("advances", lang)}</h1></div>
          <Button asChild size="sm"><Link href="/portal/driver/advances/new"><Plus className="mr-1 h-4 w-4" />{t("newAdvance", lang)}</Link></Button>
        </div>
      </header>
